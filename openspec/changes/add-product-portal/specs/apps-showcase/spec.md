...
<!-- Superseded by product-portal's "Homepage product-line card wall": the
homepage now presents the four-line card wall linking to catalog tabs,
not a flat list of app entries. -->
