...
The site SHALL provide the following pages: homepage with hero, `/apps`,
`/repos`, `/docs`, `/demo`, `/indicators`, and a footer with org links. The
...
- **THEN** the apps grid renders in the corresponding locale

#### Scenario: Navigation includes Apps
- **WHEN** a visitor views the header navigation
- **THEN** an "Apps" (EN) / "产品" (中文) entry links to the apps grid
