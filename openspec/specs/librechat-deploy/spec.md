# librechat-deploy Specification

## Purpose

Deploy a slim LibreChat instance on the k3s cluster via the official Helm chart, with RAG components disabled, LiteLLM as the sole LLM endpoint, NodePort exposure, resource limits fit for a 4 GB node, persistent MongoDB, and secrets sourced from Kubernetes Secrets.
